...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="sm:w-[200px] w-full rounded-[15px] bg-[#102C57] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="block">
          ...
          <p className="mt-[5px] font-epilogue font-normal text-[#E1EDEB] text-left leading-[25px] truncate">{description}</p>
        </div>
